        ...
        <Navbar bg={bgNavBar} variant={variantNavBar} expanded={expanded} expand="lg" className="navbar" style={{fontSize:"120%", position:"fixed",top:0,width:"100%", zIndex:1000}}>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav activeKey={path} className="mr-auto">
                    ...
                    <NavLink key="1" onClick={() => setExpanded(false)} className="nav-link" to="#parcours">Parcours professionnel</NavLink>
                    <NavLink key="2" onClick={() => setExpanded(false)} className="nav-link" to="#projets">Projets</NavLink>
